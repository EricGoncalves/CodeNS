...
!
    ...
    double precision ::     nz,    pl,   prr,    ps,   pst
    double precision ::    q2l,   q2r,rhoest,  rhol,  rhom
    double precision ::   rhor, rhost,rhoust,rhovst,rhowst
    double precision ::    si1,   si2,   si3,   si4,   si5
    double precision ::    sj1,   sj2,   sj3,   sj4,   sj5
    double precision ::    sk1,   sk2,   sk3,   sk4,   sk5
    double precision ::     sl,    sn,    sr,   sst,     u
    double precision ::     ul,    um,    ur,     v, vitm2
    double precision ::     vl,    vm,   vnl,   vnm,   vnr
