...
!
  call mpi_open(lec  ,file='flec')
  call mpi_open(imp  ,file='fimp')
  call mpi_open(out  ,file='fout')
  call mpi_open(sec  ,file='fsec')
  call mpi_open(sor1 ,file='smoy')
  call mpi_open(sor2 ,file='pres')
  call mpi_open(sor3 ,file='resro')
  call mpi_open(kfa  ,file='fcla',form='formatted')
  call mpi_open(kdgv ,file='fgv' ,form='unformatted')
  call mpi_open(kdgc ,file='fgc' ,form='unformatted')
  call mpi_open(kdac ,file='fac' ,form='unformatted')
  call mpi_open(kdav ,file='fav' ,form='unformatted')
!      call mpi_open(kdgcf,file='fgcf',form='unformatted')
!      call mpi_open(kdacf,file='facf',form='unformatted')
!      call mpi_open(kfi  ,file='fi'  ,form='unformatted')
!      call mpi_open(kfb  ,file='fb'  ,form='unformatted')
!      call mpi_open(kfn  ,file='fn'  ,form='unformatted')
!      call mpi_open(kfc  ,file='fc'  ,form='unformatted')
!      call mpi_open(kfr  ,file='fr'  ,form='unformatted')
!      call mpi_open(kres ,file='fres',form='unformatted')
!
