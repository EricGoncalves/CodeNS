...
!
!     ACT
!_A    Ecriture formatee sur le fichier fimp des indices des points
!_A    des frontieres de domaines structures.
!
!     INP
...
!
!     COM
!_C   Impression des indices ncbd.
...
!
      ...
      write(imp,1910) mm,n,l,img,i,j,k
      enddo
!
 1900 format(1h1//1x,'    m',2x,'      ncbd',2x,'  l',2x,'img', &
             2x,'  i',2x,'  j',2x,'  k'/)
