...
!
    ...
    double precision ::    q2r,   qcx,   qcy,   qcz,  qinf
    double precision :: rhoest,  rhol,  rhom,  rhor, rhost
    double precision :: rhoust,rhovst,rhowst,   si1,   si2
    double precision ::    si3,   si4,   si5,   sj1,   sj2
    double precision ::    sj3,   sj4,   sj5,   sk1,   sk2
    double precision ::    sk3,   sk4,   sk5,    sl,    sn
    double precision ::     sr,   sst,  toxx,  toxy,  toxz
    double precision ::   toyy,  toyz,  tozz,     u,    ul
    double precision ::     um,    ur,     v, vitm2,    vl
    double precision ::     vm,   vnl,   vnm,   vnr,    vr
