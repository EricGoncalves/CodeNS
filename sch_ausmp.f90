...
!_A    Ordre 1 et ordre superieur avec extrapolation MUSCL.
...
!
    ...
    double precision ::  cmi, cml, cmr,cnds,   d
    double precision ::   dm, fex, fey, fez,  ff
    double precision ::  fmm, fmp, fpm, fpp, fxx
    double precision ::  fxy, fxz, fyy, fyz, fzz
    double precision ::  hi1, hi2, hi3, hi4, hi5
    double precision ::  hj1, hj2, hj3, hj4, hj5
    double precision ::  hk1, hk2, hk3, hk4, hk5
    double precision ::   hl,  hr, phi,  pl, prr
    double precision ::   ps, psi, qcx, qcy, qcz
    double precision ::   ra,rhol,rhor, si1, si2
    double precision ::  si3, si4, si5, sj1, sj2
    double precision ::  sj3, sj4, sj5, sk1, sk2
    double precision ::  sk3, sk4, sk5,  sn,  ta
    double precision :: toxx,toxy,toxz,toyy,toyz
    double precision :: tozz,   u,  ul,  ur,   v
    double precision ::   vl,  vr,  wl,  wr,  xa
!
!-----------------------------------------------------------------------
!
