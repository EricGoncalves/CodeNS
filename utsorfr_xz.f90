...
!
        write(sor2,'(''VARIABLES = '',a1,6(a,a1,'', '',a1),a,a1)') &
          c,'x/L',c, c,'y/L',c, c,'z/L',c, &
          c,'Cf0',c, c,'Kp',c, c,'phip',c
...
!555          format(3(1pe12.4),6(1pe11.3),2x,4(1pe11.3),2i4,2(1pe11.3))
            write(sor2,555) xcfac,ycfac,zcfac,cfinf0,akp,abs(phip)
 555        format(3(1pe12.4),3(1pe11.3))
