...
!
    ...
    double precision ::                   al,                  ar,              beta2l,              beta2r,                cnds
    double precision ::                  cpl,                 cpr,                dfex,                dfey,                dfez
    double precision ::                 dfxx,                dfxy,                dfxz,                dfyy,                dfyz
    double precision ::                 dfzz,                 di1,                 di2,                 di3,                 di4
    double precision ::                  di5,                 dj1,                 dj2,                 dj3,                 dj4
    double precision ::                  dj5,                 dk1,                 dk2,                 dk3,                 dk4
    double precision ::                  dk5,                  el,                  er,                  f1,                  f2
    double precision ::                   f3,                  f4,                  f5,                 fex,                 fey
    double precision ::                  fez,       ff(ip11,ip60),                 fxx,                 fxy,                 fxz
    double precision ::                  fyy,                 fyz,                 fzz,                  g1,                  g2
    double precision ::                   g3,                  g4,                  g5,                  h1,                  h2
    double precision ::                   h3,                  h4,                  h5,                  hl,                  hr
    double precision ::                   nx,                  ny,                  nz,            pl(ip00)
    double precision ::            prr(ip00),            ps(ip11),                 q2l,                 q2r,           qcx(ip12)
    double precision ::            qcy(ip12),           qcz(ip12),                qinf,          rhol(ip00),          rhor(ip00)
...
!
  ...
  end subroutine sch_rusanov_prcd
end module mod_sch_rusanov_prcd
