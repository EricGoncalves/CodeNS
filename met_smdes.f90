...
!
    ...
    double precision ::    dvzy,   dvzz,    dxg,    ft2,    fv1
    double precision ::     fv2,     fw,  kapd2, kappa2,     mu
    double precision :: nutilde, qcxts5, qcyts6,  rtil6, rtilde
    double precision ::    sdif,    sm1,    sm2,     sn, stilde
    double precision ::       t, txxf5x, txyf5y, txzf5z,   uns3
