module mod_implimf_2d
  implicit none
contains
  subroutine implimf_2d( &
       lm,u,dt,v,d,ff, &
       mu,mut, &
       equat,lmx, &
       sn,lgsnlt, &
...
!
    ...
    integer          ::    njd
    double precision ::    cc, cnds, cson,    d , fzz
    double precision ::  dfex, dfey, dfez, dfxz, dfyz, dfzz
    double precision ::  dfxx, dfxy, dfyy,   dt, dtpas, fyz
    double precision ::  fact,  fex,  fey,   fez,  ff,  fxx
    double precision ::   fxy,  fyy,   fxz ,  mu,  mut, pres
    double precision ::    ps,   rv,   sn,  tn1,  tn2, tn4
    double precision ::   tn3,  tn5,    u,   ui,   uu, ww
    double precision ::     v,   vi,   vn,  vol,   vv, wi
    double precision ::   wi1,  wi2,  wi3,  wi4,  wi5
!
!-----------------------------------------------------------------------
!
...
DEALLOCATE(coefe,coefdiag,d2w1,d2w2,d2w3,d2w4,d2w5)
  ...
  end subroutine implimf_2d
end module mod_implimf_2d
