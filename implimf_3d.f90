...
!
    ...
    double precision ::    cc, cnds, cson,    d, dfex
    double precision ::  dfey, dfez, dfxx, dfxy, dfxz
    double precision ::  dfyy, dfyz, dfzz,   dt,dtpas
    double precision ::  fact,  fex,  fey,  fez,   ff
    double precision ::   fxx,  fxy,  fxz,  fyy,  fyz
    double precision ::   fzz,   mu,  mut, pres,   ps
    double precision ::    rv,   sn,  tn1,  tn2,  tn3
    double precision ::   tn4,  tn5,    u,   ui,   uu
