...
!
    ...
    double precision ::    c13, cmui1, cmui2, cmuj1, cmuj2
    double precision ::  cmuk1, cmuk2,  dist,    mu,   mut
    double precision :: ptdual,    sn,     t, tprod,     v
    double precision ::  vdual,vdual1,vdual2,   vol
!
!-----------------------------------------------------------------------
!
!
